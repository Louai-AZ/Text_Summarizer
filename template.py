...
import logging   # To log all infos during runtime
...
list_of_files = [
    ...
    f"src/{project_name}/__init__.py",  # So that i can import files from folders 
    f"src/{project_name}/components/__init__.py", 
    f"src/{project_name}/utils/__init__.py",
    f"src/{project_name}/utils/common.py", # Inside this file, i'll write All my utility
    ...
    "requirements.txt",
    "setup.py",
    "research/trials.ipynb", # will cotain all the notebook experiments
    ]
